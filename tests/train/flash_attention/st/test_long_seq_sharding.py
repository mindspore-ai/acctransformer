...
@pytest.mark.parametrize(
    "q_shape, kv_shape",
    [
        ((4, 1, 128 * 1024, 16), (4, 1, 128, 16)),
        ((4, 1, 128, 16), (4, 1, 128 * 1024, 16)),
        pytest.param((4, 1, 256 * 1024, 16), (4, 1, 256, 16), marks=pytest.mark.time_consuming),
        pytest.param((4, 1, 256, 16), (4, 1, 256 * 1024, 16), marks=pytest.mark.time_consuming),
    ],
)
