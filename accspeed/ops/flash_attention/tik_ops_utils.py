...
from accspeed.ops.flash_attention.constants import L0A
from accspeed.ops.flash_attention.constants import L0B
from accspeed.ops.flash_attention.constants import L0C
...
class TikOpsUtils:
    ...
    def row_sum_cube_impl(self, matrix_l1_K1MK0_ed, right_all_one_matrix_l1, rowsum_ub, m, k, precision_type):
        ...
        with self.tik_instance.new_stmt_scope(disable_sync=False):
            ...
            if precision_type == FP32:  # TODO: fp32转置接口，代替循环 => 提升性能
