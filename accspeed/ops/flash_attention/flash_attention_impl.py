...
from accspeed.ops.flash_attention.flash_attention_bwd import flash_attention_grad
from accspeed.ops.flash_attention.flash_attention_fwd import flash_attention
...
def get_flash_attention_grad(prev_block_num=65536, next_block_num=65536,
    ...
    # fa_grad.add_prim_attr("keep_prob", keep_prob)
